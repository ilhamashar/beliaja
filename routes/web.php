...
Route::group(['namespace' => 'App'], function () {
	...
	*/
	...
	Route::get('master/list-product', function(){
		return view('master/list-product');
	});
	Route::get('master/detail-product', function(){
		return view('master/detail-product');
	});
	Route::get('master/wish-list', function(){
		return view('master/wish-list');
	});
	Route::get('master/wish-list/edit', function(){
		return view('master/wish-list-edit');
	});
	Route::get('master/cart', function(){
		return view('master/cart');
	});
	Route::get('master/try', function(){
		return view('master/try');
	});
	Route::get('master/gotopay', function(){
		return view('master/gotopay');
	});
	Route::get('master/payprocess', function(){
		return view('master/payprocess');
	});
	Route::get('master/buying', function(){
		return view('master/buying');
	});
});
